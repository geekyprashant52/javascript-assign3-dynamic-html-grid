...
var clothWrapper = document.getElementById("cloth-wrapper");
var accessWrapper = document.getElementById("access-wrapper");
var addCards = (type, preview, name, brand, price) => {
  var itemDiv = document.createElement("div");
  itemDiv.className = "items";
  var previewImg = document.createElement("img");
  previewImg.className = "items-img";
  previewImg.src = preview;
  var infoDiv = document.createElement("div");
  infoDiv.className = "info-wrapper";
  var heading = document.createElement("h2");
  heading.className = "items-heading";
  heading.innerHTML = name;
  var brandText = document.createElement("p");
  brandText.className = "items-brand";
  brandText.innerHTML = brand;
  var priceText = document.createElement("h3");
  priceText.className = "items-price";
  priceText.innerHTML = "Rs " + price;
  //add to parent
  ...
  if (type) {
    //accessories
    accessWrapper.appendChild(itemDiv);
  } else {
    //clothing
    clothWrapper.appendChild(itemDiv);
  }
};

productList.map((item) => {
  //console.log("Inside map");
  addCards(item.isAccessory, item.preview, item.name, item.brand, item.price);
});
